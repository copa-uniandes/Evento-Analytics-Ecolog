...
###### Funciones
### Funci�n retornando listado de tiendas en las cuales se ofrece un dado producto cumpliendo  
### con una distancia m�xima
...
### Funci�n que guarda los valores de los Dropdowns referentes a la selecci�n de tiendas
...
### Func�on que grafica las tiendas que ha seleccionado la persona
...
### Funci�n auxiliar que construye ruta 
def constructor():
